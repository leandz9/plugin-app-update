...
public class MsgBox {
    ...
    private Dialog downgradeDialog;
    ...
    /**
     * @param downgradeDialogOnClick
     */
    public Dialog showDowngradeDialog(OnClickListener downgradeDialogOnClick) {
        if (this.downgradeDialog == null) {
            LOG.d(TAG, "initDowngradeDialog");
        ...
        if (!downgradeDialog.isShowing()) downgradeDialog.show();

        return downgradeDialog;
    }
}
